...
import { DoodleChevronRight, DoodleCheck } from "@/components/ui/DoodleIcon";
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <span className="ml-auto"><DoodleChevronRight size="sm" /></span>
  </ContextMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, variant = "default", ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && "pl-8",
      variant === "danger" && "text-red-500 focus:bg-red-500/10 focus:text-red-500",
      className
    )}
    {...props}
  />
