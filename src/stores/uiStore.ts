...
export type ViewType = "feed" | "folder" | "all" | "starred" | "readLater" | "tag" | "stats";
...
export const useUIStore = create<UIState & UIActions>()(
  persist(
    (set) => ({
      ...
      openMobileSettings: () => set({ isMobileSettingsOpen: true }),
      closeMobileSettings: () => set({ isMobileSettingsOpen: false }),
    }),
    {
      name: "rss-reader-ui",
